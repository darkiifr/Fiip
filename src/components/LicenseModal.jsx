                  ...
                  <div className="pt-3 border-t border-gray-800/50 mt-2">
                      ...
                      {updateStatus === 'available' ? (
                          ...
                          >
                              ...
                              <div className="rounded-lg border border-green-500/20 bg-green-500/5 p-3">
                                  <div className="flex items-center justify-between gap-3">
                                      <span className="text-[10px] font-bold uppercase tracking-widest text-green-300">Changelog</span>
                                      {updateInfo.date && (
                                          <span className="text-[10px] text-gray-500">{new Date(updateInfo.date).toLocaleDateString()}</span>
                                      )}
                                  </div>
                                  <pre className="mt-2 max-h-40 overflow-y-auto whitespace-pre-wrap text-xs leading-5 text-gray-300 custom-scrollbar">
                                      {updateInfo.body || t('settings.no_release_notes', 'Aucune note de version fournie.')}
                                  </pre>
                              </div>
                              <button 
                          ...
                          <motion.div
                              ...
                              className="text-xs text-blue-400 flex items-center justify-center gap-2 py-2"
                          >
