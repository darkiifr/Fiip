...
export const FIIP_ACCOUNT_PORTAL_URL = 'https://portail.fiip.fr/';
export const FIIP_ACCOUNT_DETAILS_URL = 'https://accounts.fiip.fr/user';
export const FIIP_DOWNLOAD_URL = 'https://github.com/darkiifr/Fiip/releases/latest';
