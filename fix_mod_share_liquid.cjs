const fs = require('fs');
const p = 'Mobile/src/components/ShareModal.tsx';

const t = `import React, { useState, useRef, useEffect } from 'react';
import { 
    ...
    <Modal visible={showModal} animationType="none" transparent={true} onRequestClose={handleClose}>
      ...
      <View style={styles.sheetContainer} pointerEvents="box-none">
        <Animated.View style={[
          ...
          <GlassCard cornerRadius={32} intensity={isDark ? 30 : 60} style={styles.glassContainer}>
            <View style={[
                styles.sheetContent, 
                { 
...
fs.writeFileSync(p, t.replace(/\\\\\\\`/g, "\`"));
