...
const styles = StyleSheet.create({
  caption: { fontSize: 13, lineHeight: 19, marginTop: 4 },
  content: { paddingBottom: 140, paddingHorizontal: 20, paddingTop: 12 },
  contentAndroid: { paddingHorizontal: 16, paddingTop: 8 },
  header: { alignItems: 'flex-start', flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 },
  kicker: { fontSize: 12, fontWeight: '800', letterSpacing: 0.8, textTransform: 'uppercase' },
  section: { marginBottom: 18 },
  sectionCard: { gap: 10, padding: 10 },
  sectionTitle: { fontSize: 12, fontWeight: '900', letterSpacing: 0.9, marginBottom: 8, marginLeft: 8, textTransform: 'uppercase' },
  segment: { alignItems: 'center', borderRadius: 14, flex: 1, justifyContent: 'center', minHeight: 38 },
  segmentText: { fontSize: 13, fontWeight: '900' },
  segmented: { borderRadius: 18, flexDirection: 'row', gap: 4, padding: 4 },
  settingRow: { alignItems: 'center', flexDirection: 'row', gap: 14, minHeight: 70, paddingHorizontal: 6 },
  settingText: { flex: 1 },
  settingTitle: { fontSize: 15, fontWeight: '900' },
  title: { fontSize: 36, fontWeight: '900', marginTop: 4 },
});
