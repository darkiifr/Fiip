...
const styles = StyleSheet.create({
  ...
  answerText: { fontSize: 16, lineHeight: 24, marginTop: 12 },
  cardLabel: { fontSize: 11, fontWeight: '800', letterSpacing: 0.8, textTransform: 'uppercase' },
  composer: { bottom: 24, left: 16, position: 'absolute', right: 16 },
  content: { gap: 14, paddingBottom: 132, paddingHorizontal: 20 },
  header: { alignItems: 'center', flexDirection: 'row', gap: 14, paddingBottom: 14, paddingHorizontal: 20, paddingTop: 8 },
  ...
  noteCard: { padding: 18 },
  noteText: { fontSize: 14, lineHeight: 21, marginTop: 8 },
  noteTitle: { fontSize: 22, fontWeight: '900', marginTop: 8 },
  quickGrid: { flexDirection: 'row', gap: 10 },
  quickItem: { flex: 1 },
  replaceButton: { alignItems: 'center', borderRadius: 23, height: 46, justifyContent: 'center', marginTop: 16 },
  replaceButtonAndroid: { alignItems: 'center', borderRadius: 24, elevation: 1, height: 48, justifyContent: 'center', marginTop: 16 },
  replaceText: { color: '#FFF', fontWeight: '900' },
  sendButton: { alignItems: 'center', borderRadius: Platform.OS === 'android' ? 14 : 21, height: 42, justifyContent: 'center', width: 42 },
  title: { fontSize: 24, fontWeight: '900' },
  usageCard: { padding: 16 },
  usageText: { fontSize: 18, fontWeight: '900', marginTop: 8 },
});
